...
if user_menu == "Overall Analysis":
    ...
    x = helper.most_sussesfull(df, selected_sport)
    st.table(x)
...
if user_menu == "Country-wise Analysis":
    ...
    top10_df = helper.most_sussesfull_countrywise(df, selected_country)
    st.table(top10_df)
...
if user_menu == 'Athlete-wise Analysis':
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
                     ...
                     'Rhythmic Gymnastics', 'Rugby Sevens', 'Beach Volleyball', 'Triathlon', 'Rugby', 'Lacrosse',
                     'Polo',
                     'Cricket', 'Ice Hockey']
